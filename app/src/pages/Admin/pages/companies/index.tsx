...
const CompaniesPage = injectIntl<CompaniesPageProps>(
  ({ intl, getCompanies, companies }) => {
      ...
      <AdminPage>
        <PageHeader>
          ...
          <Button onClick={newCompany}>
            <FormattedMessage id="companies.new" defaultMessage="Ny bedrift" />
          </Button>
        </PageHeader>
        <PageContent>{table()}</PageContent>
        <CompanyDialog
          open={open}
          setOpen={setOpen}
          editing={editing}
