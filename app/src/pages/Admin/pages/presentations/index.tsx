...
const PresentationsPage = injectIntl<PresentationsPageProps>(({intl, getPresentations, presentations}) => {
    ...
    <AdminPage>
      ...
      <PageContent>
        {!presentations ? (
          ...
          <ul>
            {
              presentations.map((presentation, i) => <li key={i}>{presentation.id}</li>)
            }
          </ul>
        )}
      </PageContent>
...
export default connect(mapStateToProps, mapDispatchToProps)(PresentationsPage);